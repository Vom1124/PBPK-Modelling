...
%--B4 (Lungs)
Q_b4=6500/60/CO_r;  V_b4=150/BV_r;  V_b5=144/BV_r;  PS_b4=15e-6*Q_b4;   
...
%--B9 (Coronary)
Q_b9=260/60/CO_r;   V_b9=10/BV_r;   V_b10=103/BV_r; PS_b9=15e-6*Q_b9;

Q_b11=4940/60/CO_r; V_b11=100/BV_r; %B11 (Descending Aorta)

%--B12 (Bronchial)
Q_b12=130/60/CO_r;  V_b12=5/BV_r; V_b13=144/BV_r;   PS_b12=15e-6*Q_b12;  

Q_b14=4810/60/CO_r; V_b14=100/BV_r; %B14 (Abdominal Aorta)
Q_b15=455/60/CO_r;  V_b15=20/BV_r;  %B15

%--B16 (Liver)
Q_b16=1885/60/CO_r; V_b16=71/BV_r;  V_b17=524/BV_r;  PS_b16=0.15*Q_b16;

Q_b18=495/60/CO_r;  V_b18=20/BV_r;  %B18
%--B19 (St/Sp/Pan)
Q_b19=495/60/CO_r;  V_b19=19/BV_r;  V_b20=119/BV_r;     PS_b19=19*Q_b19; 

Q_b21=935/60/BV_r;  V_b21=20/BV_r;  %B21;
%--B22 (Intestine)
Q_b22=935/60/CO_r;  V_b22=35/BV_r;  V_b23=547/BV_r;     PS_b22=19*Q_b22;

Q_b24=325/60/CO_r;  V_b24=20/BV_r;  %B24
%--B25 (Upper Extremities)
Q_b25=325/60/CO_r;  V_b25=12/BV_r;  V_b26=2751/BV_r;    PS_b25=15e-2*Q_b25;

Q_b27=2925/60/CO_r; V_b27=80/BV_r;  %B27
Q_b28=1430/60/CO_r; V_b28=20/BV_r;  %B28
%--B29 (Kidney)
Q_b29=1430/60/CO_r; V_b29=54/BV_r;  V_b30=89/BV_r;      PS_b29=19e-2*Q_b29;
Q_b31=0.19*Q_b29;   V_b31=7;      %B31 (Bladder)

Q_b32=975/60/CO_r;  V_b32=20/BV_r;  %B32;
%--B33 (Head)
Q_b33=975/60/CO_r;  V_b33=37/BV_r;  V_b34=484/BV_r;     PS_b33=15e-6*Q_b33;

Q_b35=1430/60/CO_r; V_b35=100/BV_r; %B35 (Portal Vein)

Q_b36=1495/60/CO_r; V_b36=200/BV_r; %B26
%--Trunk and Lower Extremities
Q_b37=1495/60/CO_r; V_b37=57/BV_r;  V_b38=11002/BV_r;   PS_b37=15e-6*Q_b37;
...
odefun=@(t,C) [ 
    ...
    %B2 (Right Heart)... ode2
    ((  (Q_b43*C(42)) + (Q_b1*C(1)) + (Q_b40*C(39)) + (Q_b9*C(9)) + ...
    (Q_b45*C(44)) + (Q_b12*C(12)) - (Q_b2*C(2)) )/V_b2) - ...
    (Q_b31*(C(42)+C(1)+C(39)+C(9)+C(12)+C(44))/BV_cal);
    ...
    (  (Q_b15*C(15)) + (Q_b35*C(34)) - (Q_b16*C(16)) - ...
    ...
    (   (Q_b29*(C(28)-C(29)))  -  (PS_b29*(C(29)-C(30))) )/V_b29;
    PS_b29*(C(29)-C(30))/V_b30;
    
%     %B31... ode31 (Filtration Into Bladder)
%     0.19*Q_b29*(C(29)-C(31))/5000;
    
    %B31... ode31
    Q_b32*(C(8)-C(31))/V_b32;
    
    %B32 (Head)... ode32 and ode33
    (  (Q_b33*(C(31)-C(32))) - (PS_b33*(C(32)-C(33)))  )/V_b33;
    PS_b33*(C(32)-C(33))/V_b34;
    
    %B34 (Portal Vein)... ode34
    (  (Q_b22*C(22)) + (Q_b19*C(19)) - (Q_b35*C(34))  )/V_b35;
    
    %B36... ode35
    Q_b36*(C(27)-C(35))/V_b36;
   
    %B37 (Trunk and Lower Extremities)... ode36 and ode37
    (  (Q_b37*(C(35)-C(36))) - (PS_b37*(C(36)-C(37)))  )/V_b37;
    PS_b37*(C(36)-C(37))/V_b38;  

    %B39... ode38
    Q_b39*(C(16)-C(38))/V_b39;
    
    %B40... ode39
    Q_b40*(C(25)-C(39))/V_b40;
    
    %B41... ode40
    Q_b41*(C(29)-C(40))/V_b41;
    
    %B42... ode41
    Q_b42*(C(36)-C(41))/V_b42;
    
    %B43... ode42
    Q_b43*(C(32)-C(42))/V_b43;
    
    %B44... ode43
    ( (Q_b41*C(40)) + (Q_b42*C(41)) - (Q_b44*C(43)) )/V_b44;
    
    %B45... ode44
    ( (Q_b39*C(38)) + (Q_b41*C(43)) - (Q_b45*C(44)) )/V_b45;
    
    ];

C0=zeros(1,44);% Initial conditions
C0(1)=eval(g(1))/V_b1;
...
legend('Aorta','Liver')
grid on
plot(tt,25*cc(:,24));plot(tt,25*cc(:,35));plot(tt,25*cc(:,15))
legend('Aorta','Liver','c24','c35','c15')
