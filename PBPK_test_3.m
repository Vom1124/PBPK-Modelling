...
Q2=130/60/CO_r;     V2=5/BV_r;     V16=144/BV_r;    ps16=0.05*Q2;
Q3=162/60/CO_r;     V3=40;
Q4=163/60/CO_r;     V4=40;
Q5=975/60/CO_r;     V5=80;
Q6=4810/60/CO_r;    V6=800;
Q7=6500/60/CO_r;    V7=180;
Q8=Q7;              V8=130;
Q9=6500/60/CO_r;    V9=150/BV_r;    V10=144/BV_r;   ps10=0.05*Q9;
Q11=Q7;             V11=160;   
Q12=Q7;             V12=180;
Q13=Q7;             V13=100;
Q15=4940/60/CO_r;   V15=100;    
Q17=4810/60/CO_r;   V17=100;
Q18=455/60/CO_r;    V18=20;
Q19=495/60/CO_r;    V19=20;
Q20=935/60/CO_r;    V20=20;
Q21=Q19;            V21=19/BV_r;    V22=112;BV_r;   ps22=0.05*Q21;
Q23=Q20;            V23=35/BV_r;    V24=547/BV_r;   ps24=0.05*Q23;
Q25=1430/60/CO_r;   V25=100;
Q26=1885/60/CO_r;   V26=71/BV_r;    V27=524/BV_r;   ps27=0.075*Q26;
Q28=1885/60/CO_r;   V28=100;
Q29=325/60/CO_r;    V29=20;
Q30=Q29;            V30=12/BV_r;    V31=2751/BV_r;  ps31=0.005*Q30;
Q32=2925/60/CO_r;   V32=80;
Q33=1430/60/CO_r;   V33=20;
Q34=Q33;            V34=54/BV_r;    V35=89/BV_r;    ps35=0.09*Q34;
Q37=Q33;            V37=100;
Q38=975/60/CO_r;    V38=20;
Q39=Q37;            V39=37/BV_r;    V40=484/BV_r;   ps40=0.005*Q38;
Q41=1495/60/CO_r;   V41=200;
Q42=Q41;            V42=57/BV_r;    V43=11002/BV_r; ps43=0.005*Q41;
Q44=Q41;            V44=1000;
Q45=Q32;            V45=700;
...
odefun=@(t,C) [ 
    ...
    % ode6
    (  (Q28*C(28)) + (Q45*C(45)) - (Q6*C(6))  )/V6;
    
    % ode7
    (  (Q1*C(1)) + (Q2*C(2)) + (Q3*C(3)) + (Q4*C(4)) + (Q5*C(5)) + ...
    (Q6*C(6)) - (Q7*C(7))  )/V7;
    ...
    % ode25
    (  (Q23*C(23)) + (Q21*C(21)) - (Q25*C(25))  )/V25;
    
    % ode26
    (  (Q25*C(25)) + (Q18*C(18)) - (Q26*C(26)) - (ps27*(C(26)-C(27)))  )/V26;
    % ode27
    ps27*(C(26)-C(27))/V27;
    ...
    % ode34
    (  (Q34*(C(33)-C(34)))  - (ps35*(C(34)-C(35)))  )/V34;
    % ode35    
    ps35*(C(34)-C(35))/V35;
    %ode36
    0.19*Q33*(C(13)-C(36))/54;
    
    % ode37
    Q37*(0.81*C(34)-C(36)-C(37))/V37;
    
    % ode38
    Q38*(C(13)-C(38))/V38;
    
    % ode39
    (  (Q39*(C(38)-C(39))) - (ps40*(C(39)-C(40)))  )/V39;
    % ode40
    ps40*(C(39)-C(40))/V40;
    ...
    % ode42
    (  (Q42*(C(41)-C(42))) - (ps43*(C(42)-C(43)))  )/V42;
    % ode43
    ps43*(C(42)-C(43))/V43;
    ...
    % ode45
    (  (Q37*C(37)) + (Q44*C(44)) - (Q45*C(45))  )/V45;
...
%------------Aorta
C_a=(cc(:,13)+cc(:,15)+cc(:,17))/3;%Total conc. in the aorta
