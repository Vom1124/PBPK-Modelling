...
Q8=Q7;              V8=130;
Q9=6500/60/CO_r;    V9=150/BV_r;    V10=144/BV_r;   ps9=0.05*Q9;
Q11=Q7;             V11=160;   
Q12=Q7;             V12=180/BV_r;
Q13=Q7;             V13=100/BV_r;
Q14=260/60/CO_r;    V14=10/BV_r;    V15=103/BV_r;   ps14=0.05*Q14;
Q16=4940/60/CO_r;   V16=100;
Q17=130/60/CO_r;   V17=5/BV_r;   V18=144/BV_r;      ps17=0.005*Q17;
Q19=4810/60/CO_r;    V19=100;
Q20=455/60/CO_r;    V20=20;
Q21=495/60/CO_r;    V21=20;
Q22=935/60/CO_r;    V22=20;
Q23=495/60/CO_r;    V23=19/BV_r;    V24=112;BV_r;   ps23=0.05*Q21;
Q25=Q22;            V25=35/BV_r;    V26=547/BV_r;   ps25=0.5*Q23;
Q27=1430/60/CO_r;   V27=100;
Q28=1885/60/CO_r;   V28=71/BV_r;    V29=524/BV_r;   ps28=0.1*Q28;
Q30=Q28;            V30=100/BV_r;
Q31=325/60/CO_r;    V31=20;
Q32=Q31;            V32=12/BV_r;    V33=2751/BV_r;  ps32=0.005*Q32;
Q34=162/60/CO_r;    V34=40;
Q35=163/60/CO_r;    V35=40;
Q36=2925/60/CO_r;   V36=80;
Q37=1430/60/CO_r;   V37=20;
Q38=Q37;            V38=54/BV_r;    V39=89/BV_r;    ps38=0.09*Q38;
Q40=Q37;            V40=100;
Q41=975/60/CO_r;    V41=20;
Q42=Q41;            V42=37/BV_r;    V43=484/BV_r;   ps42=0.005*Q42;
Q44=Q41;            V44=80;
Q45=1495/60/CO_r;   V45=200;
Q46=Q45;            V46=57/BV_r;    V47=11002/BV_r; ps46=0.005*Q46;
Q48=Q45;            V48=1000;
Q49=Q36;            V49=700;
Q50=Q19;            V50=800;
...
odefun=@(t,C) [ 
    ...
    % ode7
    (  (Q14*C(1)) + (Q17*C(2)) + (Q34*C(3)) + (Q35*C(4)) + (Q44*C(5)) + ...
    (Q50*C(6)) - (Q7*C(7))  -(0.19*Q38*C(38))  )/V7;
    
    % ode8
    Q8*(C(7)-C(8))/V8;
    
    % ode9
    (  (Q9*(C(8)-C(9))) - (ps9*(C(9)-C(10)))  )/V9;
    % ode10
    ps9*(C(9)-C(10))/V10;
    ...
    % ode14
    (  (Q14*(C(13)-C(1))) - (ps14*(C(1)-C(15)))  )/V14;
    % ode15
    ps14*(C(14)-C(15))/V15;
    ...
    % ode17
    (  (Q17*(C(16)-C(2))) - (ps17*(C(2)-C(18)))  )/V17;
    % ode18
    ps17*(C(2)-C(18))/V18;
    ...
    % ode23
    (  (Q23*(C(21)-C(23))) - (ps23*(C(23)-C(24)))  )/V23;
    % ode24
    ps23*(C(23)-C(24))/V24;
    
    % ode25
    (  (Q25*(C(22)-C(25))) - (ps25*(C(25)-C(26)))  )/V25;
    % ode26
    ps25*(C(25)-C(26))/V26;
    
    % ode27
    (  (Q23*C(23)) + (Q25*C(25)) - (Q27*C(27))  )/V27;
    
    % ode28
    (  (Q27*C(27)) + (Q20*C(20)) - (Q28*C(28)) - (ps28*(C(28)-C(29)))  )/V28;
    % ode29
    ps28*(C(28)-C(29))/V29;
    ...
    % ode32
    (  (Q32*(C(31)-C(32))) - (ps32*(C(32)-C(33)))  )/V32;
    % ode33
    ps32*(C(32)-C(33))/V33;
    
    % ode34
    (  (Q34*(C(32)-C(3))) + (eval(g))  )/V34;
    ...
    % ode46
    (  (Q46*(C(45)-C(46))) - (ps46*(C(46)-C(47)))  )/V46;
    % ode47
    ps46*(C(46)-C(47))/V47;
    ...
    % ode49
    (  (Q40*C(40)) + (Q48*C(48)) - (Q49*C(49))  )/V49;
    
    % ode50
    (  (Q30*C(30)) + (Q49*C(49)) - (Q50*C(6))  )/V50;
    
    ];

C0=zeros(1,50);% Initial conditions
% C0(1)=eval(g(1))/V34;
...
C_liver=(  (V28*cc(:,28)) + (V29*cc(:,29))  )/(V28+V29);
...
%------------Coronary
C_co=( (V14*cc(:,14)) + (V15*cc(:,15))  )/(V14+V15);%Total conc. in the coronary
E_co=25*C_co; %Total enhancement obtainable from the coronary

%------------Kidney
C_kid=(  (V38*cc(:,38)) + (V39*cc(:,39))  )/(V38+V39);
...
legend('Aorta','Liver')
grid on
xlim([0 300]);ylim([0 350]);xticks(0:30:300);yticks(0:50:350);
end 
